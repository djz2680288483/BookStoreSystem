                ...
                <c:forEach var="user" items="${userList}">
                    <tr>
                        ...
                        <c:if test="${!user.username.equals('admin')}">
                            <td>
                                <a href="${pageContext.request.contextPath}/user/deleteUser?userId=${user.id}" class="btn btn-danger  " role="button">删除用户</a>
                            </td>
                        </c:if>
                        <c:if test="${user.username.equals('admin')}">
                            <td>
                                <a href="#" class="btn btn-danger  disabled" role="button">删除用户</a>
                            </td>
                        </c:if>
                    </tr>
                </c:forEach>

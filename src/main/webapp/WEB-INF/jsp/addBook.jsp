...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/book/addBook" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group">
            <label>书籍类型</label>
            <input type="text" name="bookType" class="form-control" required>
        </div>
        <div class="form-group">
            <label>书籍描述</label>
        ...
        <div class="form-group">
            <label>书籍折扣</label>
            <input type="text" name="bookDiscount" class="form-control" required>
        </div>
        <div class="form-group">
            <label>书籍图片</label>
